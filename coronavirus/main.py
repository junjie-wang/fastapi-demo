...
def bg_task(url: HttpUrl, db: Session):
    ...
    with open('D:/Python/fastapi-demo/coronavirus/city.json', 'r') as c:
        city_data = json.load(c)
    ...
    with open('D:/Python/fastapi-demo/coronavirus/data.json', 'r') as d:
        coronavirus_data = json.load(d)
